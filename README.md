...
[3] 相关博客指南
1. Icarus 主题官网：https://ppoffice.github.io/hexo-theme-icarus/
2. 从零开始搭建自己的Hexo博客：https://www.cnblogs.com/liuxianan/p/build-blog-website-by-hexo-github.html 
3. 如何配置自己的 Icarus 主题：https://blog.csdn.net/Marvine/article/details/89816846 
4. GitHub文件上传指南：https://mp.weixin.qq.com/s/X2BUGMS6KQLcKeRqWP7a8g 
...
a) 确保在电脑上已安装以下工具：
	...
	2. hexo: 5.3.0 or 4.3.0
	3. git: 2.21.0(windows) or 2.17.1(ubuntu)
...
a) 从 github 下载【最新的】网页源码，到 [sues-vision.github.io] 文件夹。文件可分为 3 类：
    ...
    2. 仓库代码（readme.md and readme_imgs）；
    3. 网页源码（除了上述 1、2 之外的所有文件）。
...
c) 新建博文
	1. 在 newest 目录下运行 hexo new，即可新建博文（markdown文件）；
	2. 编辑新建的博文，主要修改 title、tags，以及正文内容；
	3. 编辑完成后，使用 hexo s，查看新建的博文在网页上的效果。
